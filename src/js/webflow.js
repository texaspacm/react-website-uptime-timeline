...
Webflow.require('ix').init([
  {"slug":"outage-desc","name":"outage desc","value":{"style":{"display":"none"},"triggers":[]}},
  {"slug":"show-outage","name":"show outage","value":{"style":{},"triggers":[{"type":"hover","selector":".outage","stepsA":[{"display":"block"},{"opacity":1,"transition":"opacity 500ms ease 0ms"}],"stepsB":[{"display":"none"}]}]}}
]);
